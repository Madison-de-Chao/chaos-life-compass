...
const SERIES: Series[] = [
  {
    ...
    read: { label: "books.momo-chao.com", url: "https://books.momo-chao.com" },
    tool: { label: "互動式小說 atzo.momo-chao.com", url: "https://atzo.momo-chao.com" },
    credit:
  ...
  },
  {
    ...
    read: { label: "books.momo-chao.com", url: "https://books.momo-chao.com" },
    tool: { label: "弧度掌控外掛 tarot.momo-chao.com", url: "https://tarot.momo-chao.com" },
    credit:
  ...
  },
  {
    ...
    read: { label: "books.momo-chao.com", url: "https://books.momo-chao.com" },
    tool: { label: "元壹宇宙神話占星系統 star.momo-chao.com", url: "https://star.momo-chao.com" },
