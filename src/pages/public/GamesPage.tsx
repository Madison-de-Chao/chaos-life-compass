...
const games = [
  ...
  },
  {
    ...
    href: "https://ehfis.momo-chao.com/",
    icon: Building2,
  ...
  },
  {
    ...
    subtitle: "認知補位器",
    philosophy: "先確認、再動手",
    description: "架在你和 AI 之間的認知中間層。不順著你說話、不把猜測當指令——先復述你真正的意思，補上你漏掉的面向，標清楚事實與推測，確認了才動手。開源、可離線、對話只存你的裝置。",
