...
const portalItems = [
  {
    ...
    description: "元壹宇宙在地球的辦事處。四系統交叉比對，看見自己的結構。",
    cta: "進入虹靈御所",
    logo: logoHongling,
    href: "/home",
  ...
  },
  {
    ...
    description: "說真話的品牌整合夥伴。合作的標準：讓你越來越強，而不是越來越依賴。",
    cta: "進入超烜創意",
    logo: logoChaoxuan,
    href: "/chaoxuan",
  ...
  },
  {
    ...
    description: "完整性導向的思維操作系統。沒有錯誤，只有未完成的弧度。",
    cta: "進入元壹宇宙",
    logo: logoYuanyi,
    href: "/universe",
  ...
  },
  {
    ...
    description: "把四十年做人的方式，變成一套別人用得上的工具。十六年品牌行銷出身，把命理、哲學、AI 認知中間層與視覺品牌串成同一套底層——完整性哲學。",
    cta: "認識默默超",
    logo: iconMomo,
    href: "/momochao",
    isExternal: false,
  ...
  {
    title: "AI 繪圖｜超烜創意",
    subtitle: "AI Art · Maison de Chao",
    description: "AI 是畫筆，不是畫家。創作方向、視覺策略、系列概念與品質篩選由人主導，AI 負責畫——三條風格線橫跨東方美學、西方奇幻、日系動畫。",
    cta: "認識 AI 繪圖",
    logo: iconArt,
    href: "/ai-art",
    isExternal: false,
  ...
  {
    title: "逗福 Tofu",
    subtitle: "Cognitive Middleware",
    description: "先確認、再動手。架在你和 AI 之間的認知中間層——先把你漏掉的面向問回來、標清楚事實與猜測，確認了才動手。",
    cta: "認識逗福",
    logo: logoTofu,
    href: "/tofu",
    isExternal: false,
...
export default function PortalPage() {
  ...
  const [cardsVisible, setCardsVisible] = useState<boolean[]>(new Array(portalItems.length).fill(false));
      ...
      <div className="relative z-10 w-full">
        ...
        {showPortal && (
          ...
          >
            ...
            {/* HIGHLIGHT：基礎課銷售頁 */}
            <div className="max-w-4xl w-full px-4 sm:px-6 mb-4 sm:mb-6">
              <Link
                to="/momochao-system"
                className="group relative block overflow-hidden rounded-2xl border border-amber-400/40 bg-gradient-to-br from-amber-500/15 via-[#1a1208]/60 to-amber-600/10 backdrop-blur-sm p-5 sm:p-6 md:p-7 transition-all duration-300 hover:border-amber-300/60 hover:from-amber-500/25 active:scale-[0.98] touch-manipulation"
                style={{ boxShadow: "0 0 40px rgba(245,158,11,0.15), inset 0 0 60px rgba(245,158,11,0.05)" }}
              >
                <div className="absolute -top-12 -right-12 w-48 h-48 rounded-full bg-amber-400/20 blur-3xl pointer-events-none group-hover:bg-amber-400/30 transition-colors" />
                <div className="relative flex flex-col sm:flex-row sm:items-center gap-4">
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className="font-display text-xl sm:text-2xl md:text-3xl text-amber-100 mb-1 leading-tight">
                      AI 時代的人生避險基金
                    </h3>
