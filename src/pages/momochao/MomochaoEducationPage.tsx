...
const courseLevels = [
  ...
  },
  {
    ...
    courses: [
      ...
      { name: "思維病毒掃描", content: "十大思維病毒辨識與拆除：時態錯位、情緒蓋過思考、防衛反應優先、極端化語言、自我應驗迴圈、因果簡化、責任轉嫁、確認偏誤、話語櫃架、悲情投射。加上四種環境層病毒：資訊過載、共識壓力、結構性不對稱、情緒傳染。", takeaway: "知道自己最常被哪些病毒劫持，以及「這個想法是我自己的，還是環境塞給我的」" },
